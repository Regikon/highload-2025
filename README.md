...
Оценим, какую стоимость подписки нужно поставить, чтобы сервис окупился (число платных пользователей нам известно, 91 миллион):  
578212.40 / 12 / (91000000) = 0.0005 (Евро)

При этом, с текущей средней ценой подписки 15 Евро, мы окупимся через  
2891062.00 / (91000000 * 15) = 0.006 месяцев.

Последние две формулы прекрасно показывают точность расчетов,
так как не учитывают многих затрат.
